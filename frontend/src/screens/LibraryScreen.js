...
export default function LibraryScreen() {
  ...
  const historyPlaylists = useMemo(() => {
    ...
    const fallbackSeed = [
      ...
      { videoId: "5yx6BWlEVcY", title: "Morning Coffee Beats", artist: "Chillhop Beats", album: "Lo-Fi Lounge", playCount: 55 },
      ...
      { videoId: "Il0S8BoucSA", title: "Shivers", artist: "Ed Sheeran", album: "=", playCount: 52 },
