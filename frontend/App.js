...
function AppContent() {
  ...
  // Parse deep link on initial mount (staytup.app/song/{id}, /album/{id}, /artist/{id}, /playlist/{id}, /user/{username})
  useEffect(() => {
    if (Platform.OS === "web" && typeof window !== "undefined") {
      ...
      if (["song", "album", "artist", "playlist", "user"].includes(section) && entityId) {
